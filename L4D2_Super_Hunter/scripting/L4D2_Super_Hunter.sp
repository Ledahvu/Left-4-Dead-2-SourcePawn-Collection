// <L4D2 Super Hunter Master> - <Biến Hunter thành Super Hunter với nhiều class và kỹ năng>
...
public Plugin myinfo = 
{
    ...
    author = "Tyn Zũ",
    description = "Biến Hunter thành Super Hunter với nhiều class và kỹ năng",
